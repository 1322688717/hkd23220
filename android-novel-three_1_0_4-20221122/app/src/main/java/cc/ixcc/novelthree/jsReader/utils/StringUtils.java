...
public class StringUtils {
    ...
    public static String dateConvert(String source, String pattern) {
        ...
        try {
            ...
            if (difSec < TIME_UNIT) {
                return difSec + "Seconds";
            } else if (difMin < TIME_UNIT) {
                return difMin + "Minutes";
            } else if (difHour < HOUR_OF_DAY) {
                return difHour + "Hours";
            } else if (difDate < DAY_OF_YESTERDAY) {
                return "Yesterday";
            } else {
                DateFormat convertFormat = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public static String getString(@StringRes int id) {
        return AppContext.sInstance.getResources().getString(id);
    }

    public static String getString(@StringRes int id, Object... formatArgs) {
        return AppContext.sInstance.getResources().getString(id, formatArgs);
    }
