...
public final class AddressDialog {
    ...
    private final static class RecyclerViewAdapter extends MyAdapter<List<AddressBean>, RecyclerView.ViewHolder> {
    ...
    private static final class AddressAdapter extends MyAdapter<AddressBean, RecyclerView.ViewHolder> {
