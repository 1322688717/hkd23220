...
public class BookChapterBeanDao extends AbstractDao<BookChapterBean, String> {
    ...
    public static class Properties {
        ...
        public final static Property Is_pay = new Property(8, boolean.class, "is_pay", false, "IS_PAY");
        public final static Property Coin = new Property(9, int.class, "coin", false, "COIN");
        public final static Property Is_Vip = new Property(10, boolean.class, "is_Vip", false, "IS__VIP");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BOOK_CHAPTER_BEAN\" (" + //
                ...
                "\"IS_PAY\" INTEGER NOT NULL ," + // 8: is_pay
                "\"COIN\" INTEGER NOT NULL ," + // 9: coin
                "\"IS__VIP\" INTEGER NOT NULL );"); // 10: is_Vip
        // Add Indexes
    ...
    protected final void bindValues(DatabaseStatement stmt, BookChapterBean entity) {
        ...
        stmt.bindLong(9, entity.getIs_pay() ? 1L: 0L);
        stmt.bindLong(10, entity.getCoin());
        stmt.bindLong(11, entity.getIs_Vip() ? 1L: 0L);
    }
    ...
    public BookChapterBean readEntity(Cursor cursor, int offset) {
        BookChapterBean entity = new BookChapterBean( //
            ...
            cursor.getShort(offset + 8) != 0, // is_pay
            cursor.getInt(offset + 9), // coin
            cursor.getShort(offset + 10) != 0 // is_Vip
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, BookChapterBean entity, int offset) {
        ...
        entity.setIs_pay(cursor.getShort(offset + 8) != 0);
        entity.setCoin(cursor.getInt(offset + 9));
        entity.setIs_Vip(cursor.getShort(offset + 10) != 0);
     }
