...
public class StringUtil {
    ...
    public static String getFormatString3(String str) {
    ...
    public static boolean isVip(UserBean bean) {
        if (bean == null) {
            return false;
        } else if (bean.getIs_vip() == null) {
            return false;
        } else {
            return TextUtils.equals("1", bean.getIs_vip());
        }
    }
...
//    }
    ...
    public static String generateFileName() {
        return "android_" + MMKV.defaultMMKV().decodeString(SpUtil.UID, "") + "_" + DateFormatUtil.getVideoCurTimeString() + sRandom.nextInt(9999) + ".jpg";
    }
    ...
    public static int parseInt(String times) {
        try {
