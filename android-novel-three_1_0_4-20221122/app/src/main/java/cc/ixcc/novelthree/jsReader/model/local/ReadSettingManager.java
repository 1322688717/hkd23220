...
public class ReadSettingManager {
    ...
    public static final String SHARED_READ_SPACING_SIZE = "shared_read_spacing_size";
    public static final String SHARED_READ_IS_SPACING_DEFAULT = "shared_read_spacing_default";
    ...
    public static final String SAVE_FREE_AD_TIME = "SAVE_FREE_AD_TIME";
    public static final String STOP_RESUME_TIME = "STOP_RESUME_TIME";
    ...
    public int getBrightness() {
        return sharedPreUtils.getInt(SHARED_READ_BRIGHTNESS, 60);
    }
    ...
    public int getSpacingSize() {
        return sharedPreUtils.getInt(SHARED_READ_SPACING_SIZE, ScreenUtils.spToPx(14));
    }

    public boolean isDefaultSpacingSize() {
        return sharedPreUtils.getBoolean(SHARED_READ_IS_SPACING_DEFAULT, false);
    }
    ...
    public PageStyle getPageStyle() {
        int style = sharedPreUtils.getInt(SHARED_READ_BG, PageStyle.BG_4.ordinal());
