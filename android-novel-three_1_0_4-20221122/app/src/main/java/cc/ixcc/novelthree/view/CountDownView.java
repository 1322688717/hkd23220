package cc.ixcc.novelthree.view;
...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRingColor = a.getColor(R.styleable.CountDownView_ringColor, context.getResources().getColor(R.color.colorProgress));

        mRingWidth = a.getFloat(R.styleable.CountDownView_ringWidth, 20);

        mRingProgessTextSize = a.getDimensionPixelSize(R.styleable.CountDownView_progressTextSize, DisplayUtil.dp2px(context, 20));

        mProgessTextColor = a.getColor(R.styleable.CountDownView_progressTextColor, context.getResources().getColor(R.color.colorProgress));
