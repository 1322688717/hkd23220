package cc.ixcc.novelthree.jsReader.model.bean;

import android.os.Parcel;
import android.os.Parcelable;


import cc.ixcc.novelthree.jsReader.model.gen.BookChapterBeanDao;
import cc.ixcc.novelthree.jsReader.model.gen.CollBookBeanDao;
import cc.ixcc.novelthree.jsReader.model.gen.DaoSession;
...
public class CollBookBean implements Parcelable {
    ...
    @Generated(hash = 945894537)
    public CollBookBean(String _id, String title, String author, String shareTitle, String shortIntro,
            String coverPic, String share_link, String cover, String classify, boolean hasCp, int latelyFollower,
            double retentionRatio, String updated, String lastRead, int paychapter, int chaptersCount,
            String lastChapter, boolean isUpdate, boolean isLocal, int iswz, int allchapter) {
        this._id = _id;
        this.title = title;
        this.author = author;
...
//        return StringUtils.convertCC(title, AppContext.sInstance);
//    }
...
//        return StringUtils.convertCC(author, AppContext.sInstance);
//    }
...
//        return StringUtils.convertCC(shortIntro, AppContext.sInstance);
        return shortIntro;
    }
...
//        return StringUtils.convertCC(cover, AppContext.sInstance);
        return cover;
    }
...
//        return StringUtils.convertCC(updated, AppContext.sInstance);
        return updated;
    }
...
//        return StringUtils.convertCC(lastChapter, AppContext.sInstance);
        return lastChapter;
    }
