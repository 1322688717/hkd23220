...
public class Config {
    ...
    private final static String BOOK_PAGE_BG_KEY = "bookpagebg";
    ...
    private final static String HUYAN_KEY = "huyan";
    private final static String PAGE_MODE_KEY = "pagemode";

    public final static String FONTTYPE_DEFAULT = "";
    public final static String FONTTYPE_QIHEI = "font/Francisco.ttf";
    public final static String FONTTYPE_WAWA = "font/Francisco.ttf";

    public final static String FONTTYPE_FZXINGHEI = "font/Francisco.ttf";
    public final static String FONTTYPE_FZKATONG = "font/Francisco.ttf";
    public final static String FONTTYPE_BYSONG = "font/Francisco.ttf";

    public final static int BOOK_BG_NIGHT = -1;
    ...
    public final static int PAGE_MODE_UPDOWN = 3;
    public final static int PAGE_MODE_NONE = 4;
...
//        return sp.getInt(PAGE_MODE_KEY,PAGE_MODE_SIMULATION);
    ...
    public int getBookPageBg(){
        return sp.getInt(BOOK_PAGE_BG_KEY,R.color.read_bg_default);
    }

    public void setBookPageBg(int color){
        sp.edit().putInt(BOOK_PAGE_BG_KEY,color).commit();
    }
    ...
    public Boolean isHuyan(){
        return sp.getBoolean(HUYAN_KEY,false);
    }

    public void sethuyan(Boolean ishuyan){
        sp.edit().putBoolean(HUYAN_KEY,ishuyan).commit();
    }
