 ...
 */
public class SettingDialog2 extends Dialog {
    ...
    private SettingDialog2(Context context, boolean flag, OnCancelListener listener) {
    ...
    public SettingDialog2(Context context, int themeResId) {
