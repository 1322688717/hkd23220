...
public class SexDialog extends Dialog {
    ...
    static SexDialog myDialog = null;
     ...
     */
    public static SexDialog getMyDialog(Activity context) {
        mContext = context;
        myDialog = new SexDialog(context, R.style.dialog2);// 创建自定义样式dialog
        myDialog.setContentView(R.layout.dialog_sex);// 得到加载view
...
//        myDialog.getWindow().getAttributes().gravity = Gravity.CENTER;//设置显示位置为中间
    ...
    private void initUI() {
        boy = myDialog.findViewById(R.id.boy);
        girl = myDialog.findViewById(R.id.girl);
        ...
        boy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mDialogCallBack != null) {
                    mDialogCallBack.onSexClick(true);
                }
            }
        });
        girl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mDialogCallBack != null) {
                    mDialogCallBack.onSexClick(false);
                }
            }
        });
     ...
     * @return
     */
    public SexDialog setMessage(String strMessage) {
