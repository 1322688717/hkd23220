...
-keepclassmembernames class cc.ixcc.novelthree.http.response.** {
    <fields>;
}
# 保护模型类的字段不被混淆（请注意修改包名路径）
-keepclassmembernames class cc.ixcc.novelthree.http.model.HttpData {
    <fields>;
}
